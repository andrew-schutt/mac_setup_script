class Setup < Thor
  ...
  def kickoff
    ...
    brews = %w(git elixir cowsay postgresql mysql mongodb heroku fortune zsh graphviz imagemagick
             mono exercism tree kubectl cfssl)
    brews.each do |brew|
    ...
    casks = %w(alfred atom bartender caffeine dash firefox flux google-chrome iterm2 kaleidoscope postico
               slack onyx vlc tower postman ngrok)
     casks.each do |cask|
